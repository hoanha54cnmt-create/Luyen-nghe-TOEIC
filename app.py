...
# ==========================================
# 2. KẾT NỐI GOOGLE SHEETS (GIỮ NGUYÊN MÃ CỦA BẠN Ở ĐÂY)
# ==========================================
# (Lưu ý: Đoạn kết nối này tôi viết theo chuẩn, nếu code cũ của bạn 
# đang kết nối tốt thì bạn cứ dùng đoạn kết nối cũ thay vào phần này nhé)
